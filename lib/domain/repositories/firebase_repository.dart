...
abstract class FirebaseRepository{
  ...
  Future<void> createOneToOneChatChannel(String uid,  String name, List<UserEntity> allUsers);
  ...
  Future<void> sendTextMessage(TextMessageEntity textMessageEntity,String channelId, UserEntity allUsers);

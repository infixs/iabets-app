...
class FirebaseRepositoryImpl implements FirebaseRepository {
  ...
  Future<void> sendPushMessage(
          String channelId, String title, String message) =>
      remoteDataSource.sendPushMessage(channelId, title, message);

  @override
  Stream<UserEntity> getCurrentUser() => remoteDataSource.getCurrentUser();

  @override
  Future<void> setUserToken(String token) =>
      remoteDataSource.setUserToken(token);
  ...
  Future<void> sendTextMessage(TextMessageEntity textMessageEntity,
    ...
    return remoteDataSource.sendTextMessage(
        textMessageEntity, channelId, allUsers);
  }
  ...
  Stream<DoubleConfigEntity> getDoubleConfig() {
    return remoteDataSource.getDoubleConfig();
  }
